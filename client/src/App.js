            ...
            await contract.methods
                .modifyCustomerData(
                    ...
                    crypto
                        .createHash("sha1")
                        .update(
                            this.state.name + this.state.aadhar + this.state.pan
                        )
                        .digest("hex"),
                    this.state.bank_verify
                )
            ...
            <div className="App">
                    ...
                    <form action="." method="" onSubmit={this.create_customer}>
                        <fieldset>
                            <div className="form-title form-bottom-padding">
                                <strong>
                                    Customer Registration Form (New customers
                                    only)
                                </strong>
                            </div>
                            ...
                            <p>
                                <label>
                                    Organisation Address you want to verify your
                                    data with{" "}
                                </label>
                                <input
                                    type="text"
                ...
                <div className="new-bank">
                    <form action="." method="" onSubmit={this.create_bank}>
                        <fieldset>
                            <div className="form-title form-bottom-padding">
                                <strong>
                                    Organisation registration form (New
                                    organisations only)
                                </strong>
                            </div>
                            <p>
                ...
                <div className="existing-customer">
                    <form action="." method="" onSubmit={this.modify_data}>
                        <fieldset>
                            <div className="form-title form-bottom-padding">
                                <strong>
                                    Update existing customer data (existing
                                    customers only)
                                </strong>
                            </div>
                ...
                <div className="existing-bank">
                    <fieldset>
                        ...
                        <p>
                            <button onClick={this.viewRequests}>
                                View user Requests
                            </button>
                        </p>
                        <GetAllBankRequests
                ...
                <div className="existing-bank">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            <input
                                type="text"
                                onChange={this.myDataChangeHandler}
                            />
                        </p>
                        <p>
                            <label>Aadhar </label>
                            <input
                                type="text"
                                onChange={this.myData1ChangeHandler}
                            />
                        </p>
                        <p>
                            <label>Pan </label>
                            <input
                                type="text"
                                onChange={this.myData2ChangeHandler}
                            />
                        </p>
                ...
                <div className="existing-customer">
                    ...
                    <div>
                        ...
                        <p>
                            <button onClick={this.getmystatus}>
                                Get Customer Status
                            </button>
                        </p>
